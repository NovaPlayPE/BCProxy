...
import net.novaplay.jbproxy.event.*;
import net.novaplay.jbproxy.event.EventListener;
                ...
                for (File file : dictionary.listFiles(new FilenameFilter() {
                    ...
                    try {
                        ...
                        if (description != null) {
                            ...
                            if (name.toLowerCase().contains("nukkit") || name.toLowerCase().contains("minecraft") || name.toLowerCase().contains("mojang") || name.toLowerCase().contains("spigot") || name.toLowerCase().contains("bungeecord")) {
