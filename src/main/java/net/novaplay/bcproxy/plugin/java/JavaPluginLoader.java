package net.novaplay.bcproxy.plugin.java;
...
import net.novaplay.bcproxy.plugin.PluginDescription;
import net.novaplay.bcproxy.plugin.PluginException;
import net.novaplay.bcproxy.plugin.PluginLoader;
