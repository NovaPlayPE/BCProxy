package net.novaplay.bcproxy.scheduler;
...
import net.novaplay.bcproxy.plugin.*;
    ...
    public void cancelTask(int taskId) {
        if (taskMap.containsKey(taskId)) {
            try {
                ...
                Server.getInstance().getLogger().info("Exception while invoking onCancel\n\r"+Utils.getExceptionMessage(ex));
            }
        }
    }
        ...
        while (isReady(currentTick)) {
            ...
            if (taskHandler.isCancelled()) {
                ...
                try {
                    ...
                    Server.getInstance().getLogger().info("Could not execute taskHandler " + taskHandler.getTaskName() + ": " + e.getMessage());
